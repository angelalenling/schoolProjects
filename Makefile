...
smock: matrix_1.o matrix_4.o work_queue.o worker_pool.o task_group.o smock_main.c
	$(CC) -o $@ $^ -lm -lpthread

matrix_4.o: matrix.h matrix_4.c
	$(CC) -c matrix_4.c
...
clean:
	rm -f smock matrix_4.o work_queue.o worker_pool.o task_group.o
